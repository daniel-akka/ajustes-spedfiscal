...
<div>
    ...
    <h1>Home</h1>
    `;return n.innerHTML=o,n},r=document.getElementById("main"),u=()=>{window.addEventListener("hashchange",()=>{switch(r.innerHTML="",window.location.hash){case" ":r.appendChild(a());break;case"#ConfiguracoesEmail":console.log("Page config"),r.appendChild(l());break;case"#ExtrairEstoque":console.log("Page config"),r.appendChild(d());break;default:r.appendChild(a())}})};window.addEventListener("load",()=>{r.appendChild(a()),u()});
