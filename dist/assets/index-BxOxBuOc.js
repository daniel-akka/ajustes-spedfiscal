(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))n(e);new MutationObserver(e=>{for(const a of e)if(a.type==="childList")for(const r of a.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&n(r)}).observe(document,{childList:!0,subtree:!0});function c(e){const a={};return e.integrity&&(a.integrity=e.integrity),e.referrerPolicy&&(a.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?a.credentials="include":e.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function n(e){if(e.ep)return;e.ep=!0;const a=c(e);fetch(e.href,a)}})();const l=()=>{const o=document.createElement("div"),t=`
    <h1>Home</h1>
...
<div class="button-inline-block">
    ...
    `;return o.innerHTML=t,o},i=document.getElementById("main"),p=()=>{window.addEventListener("hashchange",()=>{switch(i.innerHTML="",window.location.hash){case" ":i.appendChild(l());break;case"#ConfiguracoesEmail":i.appendChild(s());break;case"#ExtrairEstoque":i.appendChild(d());break;case"#CorrigirEstoque":i.appendChild(u());break;default:i.appendChild(l())}})};window.addEventListener("load",()=>{i.appendChild(l()),p()});
